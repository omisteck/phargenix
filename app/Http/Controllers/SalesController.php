...
class SalesController extends Controller
{
    ...
    public function invoice_number(Request $request)
    {
    ...
    public function print($invoice_number)
    {
        ...
        $sum = Sales::where('invoice_number', $invoice_number)->sum("total");
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'invoice' => 'required|numeric|unique:sales,invoice_number',

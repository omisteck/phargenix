<template>
    <layout :page_title="'Staffs'">
        <div class="row layout-top-spacing" id="cancel-row">
            <div class="col-lg-12">
                <a href="#" class="btn btn-success mb-3 ml-3" data-toggle="modal" data-target="#createModel">Create
                    Staff</a>
            </div>
            ...
            <div class="col-xl-10 col-lg-10 col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-6">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 d-flex justify-content-sm-start justify-content-center">
                                    <div class="dataTables_length">
                                        <label>Results :
                                            <select v-model="filter.pagination" @change="getResults" class="form-control">
                                ...
                                <div
                                    ...
                                    <div class="dataTables_filter">
                                        <label><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            </svg><input type="search" @keyup="getResults" v-model="filter.search"
                                                class="form-control" placeholder="Search..." /></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="zero-config" class="table dt-table-hover dataTable" style="width: 100%" role="grid">
                                ...
                                <tbody>
                                    <tr v-for="staff in laravelData.data" :key="staff.id" v-if="staff.user != null">
                                        ...
                                        <td v-if="staff.branch != null">
                                            {{ staff.branch.shortname }}
                                        </td>
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop2">
                                                    ...
                                                    <a href="#" @click="
                                                        ...
                                                        " class="dropdown-item">Permissions</a>
                        ...
                        <div class="dt--bottom-section d-sm-flex justify-content-sm-between text-center">
                            ...
                            <div class="dt--pagination">
                                <div class="dataTables_paginate paging_simple_numbers" id="zero-config_paginate">
                                    <ul class="pagination">
                                        <pagination :limit="1" :data="laravelData" @pagination-change-page="getResults">
                                            <span slot="prev-nav"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <div class="dt--bottom-section d-sm-flex justify-content-sm-between text-center">
                                    <div class="dt--pages-count  mb-sm-0 mb-3">
                                        <div class="dataTables_info" id="zero-config_info" role="status" aria-live="polite">
                                            Showing page {{ laravelData.current_page }} of {{ laravelData.last_page }}
                                        </div>
                                    </div>
                                    <div class="dt--pagination">
                                        <div class="dataTables_paginate paging_simple_numbers" id="zero-config_paginate">
                                            <ul class="pagination">
                                                <pagination :limit=1 :data="laravelData"
                                                    ...
                                                    <span slot="next-nav"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="name" v-model="staff.name"
                                                    required placeholder="John Doe">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="shortname">Username</label>
                                                <input type="text" class="form-control" id="shortname"
                                                    v-model="staff.username" required placeholder="Doe201">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row mb-4">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="phone" v-model="staff.phone"
                                                    required placeholder="09064629981">
                                            </div>
                                        </div>
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-3">
                                                <label for="address">Role</label>
                                                <select class="form-control d-inline-block" v-model="staff.position"
                                                    required>
                                            ...
                                            <div class="form-group col-md-9">
                                                ...
                                                <input type="text" class="form-control" id="address" v-model="staff.address"
                                                    placeholder="1234 Main Street, Lagos State, Nigeria">
                                            </div>
                                        </div>

                                        <div class="form-group mb-4">
                                            <label for="address">Branch</label>
                                            <vue-taggable-select make-it-taggable="good!" :taggable="true"
                                                v-model="staff.branch" :options="branches"></vue-taggable-select>
                                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group mb-4">
                                            <label for="address">Branch</label>
                                            <vue-taggable-select make-it-taggable="good!" :taggable="true"
                                                v-model="editBranch" :options="branches"></vue-taggable-select>
                                            <div class="mt-3">
                                                <h6>Selected: </h6>
                                                <p class="text-secondary">
                                                    <button type="button" @click="deleteBranch(branch, index)"
                                                        class="btn btn-primary m-2" v-for="(branch, index) in editBranch"
                                                        :key="branch">
                    ...
                    <div class="modal fade" id="permission" tabindex="-1" role="dialog" aria-labelledby="permissionLabel"
                        aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <form method="POST" @submit.prevent="savePermission">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="permissionLabel">Edit Permission for {{
                                            permission.user.name }} </h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-12 mb-5">
                                                ...
                                                <span class="m-2 btn btn-success btn-sm"
                                                    v-for="access in permission.currentAccess"
                                                    :key="access.id">{{ access.name }}</span>
                                            </div>
                                            <div class="col-6" v-for="permit in permissions" :key="permit.id">
                                                <div class="n-chk">
                                                    <label class="new-control new-checkbox checkbox-success">
                                                        <input type="checkbox" class="new-control-input"
                                                            v-model="permission.access" :value="permit.name">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-row mb-4">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" id="name"
                                                                    v-model="staff.name" required placeholder="John Doe" />
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label for="shortname">Username</label>
                                                                <input type="text" class="form-control" id="shortname"
                                                                    v-model="staff.username" required
                                                                    placeholder="Doe201" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-row mb-4">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" id="email"
                                                                    v-model="staff.email" placeholder="Johndoe@gmail.com" />
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label for="phone">Phone</label>
                                                                <input type="text" class="form-control" id="phone"
                                                                    v-model="staff.phone" required
                                                                    placeholder="09064629981" />
                                                            </div>
                                                        </div>
                                                        <div class="form-row mb-4">
                                                            <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <vue-taggable-select make-it-taggable="good!" :taggable="true"
                                                                ...
                                                                :options="branches"></vue-taggable-select>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                            ...
                                                            <div class="mt-3">
                                                                ...
                                                                <p class="text-secondary">
                                                                    <button type="button" @click="
                                                                        ...
                                                                        " class="btn btn-primary m-2" v-for="(branch,
        index) in editBranch" :key="branch">
                                                                        {{ branch }}
                                    ...
                                    <div class="modal fade" id="permission" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <form method="POST" @submit.prevent="savePermission">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="permissionLabel">
                                                            Edit Permission for
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div class="col-6" v-for="permit in permissions"
                                                                :key="permit.id">
                                                                <div class="n-chk">
                                                                    <label
...
created: function() {
    ...
    $("head").append(
        $(
            '<link rel="stylesheet" id="table" class="remove" type="text/css" />'
        ).attr(
            "href",
            "/dashboard/plugins/table/datatable/dt-global_style.css"
        )
    );
},
...
methods: {
    ...
    edit(user) {
        this.staff = user.user;
        axios
            .get(route("staff.branches", { user: this.staff.id }))
            .then(response => {
                this.editBranch = response.data;
            });
    ...
    givePermission(user) {
        this.permission.user = user;
        this.permission.access = JSON.parse(user?.access_permissions);
        $("#permission").modal("show");
    },
    savePermission() {
        axios.post("save/permission", this.permission).then(response => {
            this.$toast.success(response.data.success);
            (this.permission = {
                user: {},
                access: []
    ...
    loginAs(staff) {
        axios.post("login/as/staff", staff).then(response => {
            window.location = "/home";
        });
    },
    ...
    createStaff() {
        axios
            .post(route("user.store"), this.staff)
            .then(response => {
                this.staff = {};
        ...
        this.$swal
            ...
            .then(result => {
                if (result.isConfirmed) {
                    axios
                        .delete(route("user.destroy", { user: staff.id }))
                        .then(response => {
                            this.$swal.fire(
                                "Disable!",
                                "Your disable a staff successfully.",
                                "success"
                            );
                            this.getResults();
    ...
    updateStaff() {
        ...
        axios
            .put(route("user.update", this.staff.id), this.staff)
            .then(response => {
                this.$toast.success(response.data.success);
                this.staff = {};

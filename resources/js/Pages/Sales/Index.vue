...
<layout :page_title="'Sales'">
 <div class="row layout-top-spacing" id="cancel-row">
     <div class="col-lg-12">
        <inertia-link href="/sales/create" class="btn btn-success mb-3 ml-3" >Enter Sales</inertia-link>
     </div>
...
mounted : function(){
  ...
  methods: {
      ...
      getResults(page =1) {
                ...
                axios.get('api/sales?page=' + page +"&pagination=" + this.filter.pagination  +"&search=" + this.filter.search)
                    .then( response => {
...
this.$swal.fire({
  ...
  if (result.isConfirmed) {
      this.isLoading = true;
            axios.delete(route('delete_sale',{'sales': sale.id}))
            .then((response) => {
                this.getResults();
                this.isLoading = false;
               this.$swal.fire(
